...
<div class="content">
    ...
    <div class="prodotti">
        ...
        <div class="product">
            ...
            <div class="iconDelete"><a href="./admin?op=elimina&id=<%=bean.getIdProdotto()%>">
                <button onclick="reload()"><img src="img/delete.png"></button>
            </a></div>
            <div class="iconModify"><a href="./admin?op=modProd&id=<%=bean.getIdProdotto() %>">
                <button><img src="img/Modifica.png" class="image"></button>
            </a></div>
        </div>
        <%} %>
    </div>
