...
<!DOCTYPE html>
<html>
<%@ page contentType="text/html; charset=UTF-8" import="java.util.*,model.bean.*,model.*,model.dao.*"%>

<head>
<link rel="stylesheet" href="css/style.css">
<meta charset="UTF-8">
<link rel="icon" type="image/png" href="img/logo2vicon.png" />
<title>Primigioco: Admin-OrdiniGenaral</title>
</head>
<body>
